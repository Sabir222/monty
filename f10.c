...
/**
 * rotlastnode - Executes the majestic spin
 * move on the top node of the stk.
 * @stk: Pointer to a pointer trying to impress
 * its top node with a dance routine.
 * @ligne: Integer representing the line number,
 * because even code deserves a stage.
 */
